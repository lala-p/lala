...
<html>
    ...
    <body>
        ...
        <section>
            ...
            <form method="GET" action="insert_action.php" id="f1"> 
                ...
                <table border="1" width="600px">
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            $query = "SELECT max(custno) as nextno FROM member_tbl_02";
                        ...
                        <td><input type="text" name="custno" id="custno" value="<? echo $nextno ?>" readonly="readonly" style="float: left; width: 100px;"></td>
                    ...
                    <tr>
                        <td colspan="2">
                            <button type="button" onclick="f1click()">등록</button>
